...
<body>
    ...
    <header id="bandeau" class="container">
        <nav role="navigation" class="navbar navbar-expand-md navbar-dark justify-content-center">
            <div class="logo">
                <a title="renvoi à l'accueil" href="index.php">
            ...
            <div id="menu" class="collapse navbar-collapse">
                <ul class="navbar-nav justify-content-center">
                    <li class="nav-item d-flex justify-content-center active">
                        <a class="nav-link" href="?action=acueil">Accueil</a>
                    </li>
